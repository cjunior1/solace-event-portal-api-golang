...
import (
	...
	swagger "github.com/cjunior1/solace-event-portal-api-golang"
)
...
func main() {
	...
	ctx = context.WithValue(ctx, swagger.ContextAccessToken, "eyJhbGciOiJSUzI1NiIsImtpZCI6Im1hYXNfcHJvZF8yMDIwMDMyNiIsInR5cCI6IkpXVCJ9..bNlMRlqKuF4QUCto-0TEf0HkCk4kk0-j6Moe4tv6AADx3rFJF9gMMSvjnVjCDW1pgeBfcTgkoztkelWju5wSWXB154k71W0bu-614QuEK2ecR-_7KibVzzwRyEGYM7eVNef-5hqSHrcBOZlcI6ZBzHt-PuYOLupuEEwM8I7c6awJYTPpjloJx6aijGq38nUbaZkVrQuyFMboZuBQf8rKrpd4_fq2hd7pV13ddfInWSxN--pAuxMr13QxThAXElM6CwgxaJBM-1vSZVLWEczOP8fO7CT85BoEpw3BJxXsRlwamsCKew_Z23kqtuH2jfVVCvGv-SEDRHjKTlnuFsGDXQ")
	...
	resp, _, err := client.SchemasApi.GetSchemaVersions(ctx, &swagger.SchemasApiGetSchemaVersionsOpts{CustomAttributes: ca})
	if err != nil {
		panic(err)
	}
