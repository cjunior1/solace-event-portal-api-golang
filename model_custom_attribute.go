...
type CustomAttribute struct {
	CustomAttributeDefinitionId string `json:"customAttributeDefinitionId,omitempty"`
	CustomAttributeDefinitionName string `json:"customAttributeDefinitionName,omitempty"`
