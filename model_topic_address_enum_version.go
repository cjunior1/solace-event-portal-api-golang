...
type TopicAddressEnumVersion struct {
	...
	Values []TopicAddressEnumValue `json:"values"`
	ReferencedByEventVersionIds []string `json:"referencedByEventVersionIds,omitempty"`
	ReferencedByTopicDomainIds []string `json:"referencedByTopicDomainIds,omitempty"`
