...
type ApplicationDomainStats struct {
	...
	EnumCount int32 `json:"enumCount,omitempty"`
	EventApiCount int32 `json:"eventApiCount,omitempty"`
	EventApiProductCount int32 `json:"eventApiProductCount,omitempty"`
}
